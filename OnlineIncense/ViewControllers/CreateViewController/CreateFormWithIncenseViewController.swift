////
////  CreateFormWithIncenseViewController.swift
////  OnlineIncense
////
...
//
//class CreateFormWithIncenseViewController: UIViewController {
//
...
//                                            incense: true,
//                                            other: otherTextView.text, transfer: ) { success in
//                HUD.hide()
//                if success {
...
//}
//
//extension CreateFormWithIncenseViewController : UIPickerViewDelegate, UIPickerViewDataSource {
//
//    // ドラムロールの列数
...
//}
//
//extension CreateFormWithIncenseViewController: UITextFieldDelegate {
//
